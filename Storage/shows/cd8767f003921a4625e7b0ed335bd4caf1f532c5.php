					...
					<div class="card-body">				
						...
						<?php if($vehicles) : ?>
							...
							<?php foreach($vehicles as $vehicle) : ?>
										<tr datai="<?php echo(esc($vehicle->id)); ?>" 
										 data="<?php echo(esc($vehicle->customer_id)); ?>" 
										 datavehicle = "<?php echo(esc($vehicle->id)); ?>">
											<td id="model_name"><?php echo(esc($vehicle->model_name)); ?></td>
											<td id="vehicle_type"><?php echo(esc($vehicle->type)); ?></td>
											<td id="vehicle_size"><?php echo(esc($vehicle->size)); ?></td>
											<td id="plate_number"><?php echo(esc($vehicle->plate_number)); ?></td>
											<td id="cr_number"><?php echo(esc($vehicle->cr_number)); ?></td>
											...
											<td style="width : 220px;">
												...
												<a class="btn btn-outline-success w-100" href="http://localhost/MVC/manage/transaction/id/<?php echo(esc($vehicle->id)); ?>" id="viewTransaction">View Transaction</a>
											</td>
										</tr>							
							<?php endforeach;  ?>
									</table>
						...
						<?php else: ?>
							...
							<div class="clear-float">
								<div class="alert alert-light">
									No vehicle's avilable. Click "New Vehicle" to add.
								</div>						
							</div>
							<?php endif; ?> 
