		                            	...
		                            	<?php if($customers) : ?>
			                                <select class="form-control" name="customer_name">
			                             		<?php foreach($customers as $customer) : ?>
			                                		<option data="<?php echo(esc($customer->id)); ?>">
			                                			<?php echo(esc($customer->first_name)); ?>
			                                			<?php echo(esc($customer->middle_name[0])); ?>.
			                                			<?php echo(esc($customer->last_name)); ?></option>
			                                	<?php endforeach;  ?>
			                                </select>
		                                <?php else: ?>
			                             ...
			                             <select class="form-control" id="vehicle_type" name="vehicle_type">
			                                		<?php if($types) : ?>
			                                			<?php foreach($types as $type) : ?>
			                                				<option data="<?php echo(esc($type->id)); ?>">
			                                						<?php echo(esc($type->type)); ?>
			                                			<?php endforeach;  ?>
			                                		<?php else: ?>
