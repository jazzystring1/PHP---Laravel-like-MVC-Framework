			...
			<div class="wrapper mx-auto">
				<div class="manage-employee card mx-auto">
					...
					<div class="card-body">
						...
						<?php if($customers) : ?>
							<form class="form-inline my-2 my-lg-0 p-3 clear-float">
							   <input class="form-control mr-sm-2" placeholder="Search Record" type="text" id="search">				   
							...
							<?php foreach($customers as $customer) : ?>
										<tr data="<?php echo(esc($customer->id)); ?>">
											<td id="first_name"><?php echo(esc($customer->first_name)); ?></td>
											<td id="middle_name"><?php echo(esc($customer->middle_name)); ?></td>
											<td id="last_name"><?php echo(esc($customer->last_name)); ?></td>
											<td id="contact_number"><?php echo(esc($customer->contact_number)); ?></td>
											<td>
						...
						<?php else: ?>
							...
							<?php else: ?>
								<div class="clear-float">
									<div class="alert alert-light">
										No customer were added yet. Click "New Customer" to add.
									</div>						
								</div>
							<?php endif; ?> 
