					...
					<div class="card-body">
						...
						@if($statistics)
							...
							@endif
								...
								@if($byMonth)
								  <div class="table-responsive p-3" datayear="{{$byMonth['month']}}"
								  datamonth="{{$byMonth['year']}}">
								@endif

								@if($byYear)
								 <div class="table-responsive p-3" datayear="{{$byYear}}">	
								@endif

								@if($byTimeline)
									@if($weekTitle)
									<div class="table-responsive p-3" dataweek="{{$weekTitle}}"
									datastart="{{$byTimeline['start']}}"
									dataend="{{$byTimeline['end']}}">
									@else
									<div class="table-responsive p-3" datastart="{{$byTimeline['start']}}"
									dataend="{{$byTimeline['end']}}">	
									@endif
								@else
								...
								@foreach($statistics as $statistic)
								    	<tr data="{{$statistic->id}}">
											...
											<td>
											 {{$statistic->middle_name}}
											</td>
											<td>
											{{$statistic->count}}
											</td>
											<td class="text-center" style="width : 220px;">
												<button class="btn btn-outline-success" id="{{$graphType}}">View Graph/Timeline</button>
											</td>
										</tr>	
								@endforeach
									</table>
