				...
				<div class="manage-employee card mx-auto">
					...
					<div class="card-body">
			   				<div class="action-list">
								<button class="btn btn-outline-secondary" onclick="window.location = 'http://localhost/MVC/manage/employee'">View Employee</button>
							</div>
		   					<form class="form p-5" method="POST" action="http://localhost/MVC/manage/employee/create">
		   					@if($success)
			   					<div class="alert alert-info">
				   					Employee got successfully added!
				   				</div>
			   				@endif
